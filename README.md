...
To build the final jar and optimize the appzero application for production, run:
...
Then navigate to [http://localhost:8899](http://localhost:8899) in your browser.
