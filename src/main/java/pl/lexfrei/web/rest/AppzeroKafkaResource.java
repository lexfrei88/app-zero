...
@RestController
@RequestMapping("/api/appzero-kafka")
public class AppzeroKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AppzeroKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AppzeroKafkaResource(KafkaProperties kafkaProperties) {
